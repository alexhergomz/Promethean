"""
Video slash-command wizard for Promethean.
...
COMMAND_DEFS is the plug-in interface: promethean.py discovers
...
# ── Minimal ANSI helpers (self-contained, no import from promethean) ────────
_C = {
...
def cmd_video(args: str, _state, config) -> bool:
    ...
    _here        = os.path.dirname(os.path.abspath(__file__))   # .../promethean/video/
    _pkg_dir     = os.path.dirname(_here)                        # .../promethean/
    _versions_dir = os.path.dirname(_pkg_dir)                    # .../promethean_versions/
...
# ── Plugin interface ───────────────────────────────────────────────────────────
# promethean.py discovers slash commands via this dict.
