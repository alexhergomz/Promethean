"""
Voice slash-command for Promethean.

Extracted from promethean.py so the voice module is self-contained.
...
# Stored here so it survives promethean.py extraction.
