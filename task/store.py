"""Thread-safe task store: in-memory dict persisted to .promethean/tasks.json."""
...
# Tasks are keyed by ID, stored per session in <cwd>/.promethean/tasks.json
...
def _tasks_file() -> Path:
    return Path.cwd() / ".promethean" / "tasks.json"
