#!/usr/bin/env python3
"""
Generate animated GIF demo of promethean Telegram Bridge.
...
def draw_phone(img, chat_messages):
    ...
    # Bot name
    d.text((px+52, py+10), "@promethean_bot", font=FONT_B, fill=(255, 255, 255))
...
def build_scenes():
    ...
    add(BANNER_TG + [
        ok_line("Telegram bridge started (auto). Bot: @promethean_bot"),
    ...
    add(base + [
        ...
        None,
        ok_line("Telegram bridge is running.  Bot: @promethean_bot  Chat ID: 123456789"),
        None,
        prompt_line(cursor=True),
    ], 1000, chat=[])
    ...
    phone_init = [
        ("bot", "🟢 promethean is online. Send me a message and I'll process it.", TEAL),
    ]
    ...
    phone_r1 = phone_q1_typing + [("bot", "Here are the files in this project: promethean.py, agent.py, tools.py, providers.py, config.py …", GREEN)]
