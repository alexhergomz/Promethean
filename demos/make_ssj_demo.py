#!/usr/bin/env python3
"""
Generate animated GIF demo of promethean SSJ Developer Mode.
...
def build_scenes():
    ...
    add(base_menu + [ssj_prompt("1")] + [
        None,
        [seg("  ── Brainstorm: ", SUBTEXT), seg("promethean SSJ features", CYAN), seg(" ──", SUBTEXT)],
        None,
