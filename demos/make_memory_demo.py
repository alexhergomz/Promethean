#!/usr/bin/env python3
"""
Generate animated GIF demo of promethean Memory system using PIL.
...
def banner(session_label, date_str):
    return [
        [seg("╭─ Promethean v3.05.5 ──────────────────────────────────╮", SUBTEXT)],
...
def build_scenes():
    ...
    # ════════════════════════════════════════════════════════════════════
    add(BANNER1 + [
        divider("Session 1  —  first time using Promethean"),
        None,
        prompt_line(cursor=True),
    ], 900)

    base1 = BANNER1 + [divider("Session 1  —  first time using Promethean"), None]
