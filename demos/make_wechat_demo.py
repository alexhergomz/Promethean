#!/usr/bin/env python3
"""
Generate animated GIF demo of promethean WeChat Bridge.
...
def draw_phone(img, chat_messages):
    ...
    # Contact name
    d.text((px + 52, py + 10), "Promethean Bot", font=FONT_B, fill=title_color)
...
def build_scenes():
    ...
    phone_init = [
        ("bot", "Promethean is ready. Send me a message!", WX_COLOR),
    ]
    ...
    # ── 4: Response sent ─────────────────────────────────────────────────
    phone_r1 = phone_q1 + [("bot", "Here are the files: promethean.py, agent.py, tools.py, providers.py …", (30, 30, 30))]
