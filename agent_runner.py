...
* Iteration history is persisted to ~/.promethean/agents/<name>/log.jsonl.
...
_USER_TEMPLATES_DIR = Path.home() / ".promethean" / "agent_templates"
...
_LOG_DIR = Path.home() / ".promethean" / "agents"
